...
def generate_images(config_file, traits_file, js_file, sampleNum, submitter_name, experiment_details, experiment_id):
...
if __name__ == '__main__':
    ...
    sampleNum = 1
    generate_images(config_file, traits_file, js_file, sampleNum)